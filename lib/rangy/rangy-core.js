...
(function(global) {
    ...
    function consoleLog(msg) {
        if (isHostObject(window, "console") && isHostMethod(window.webkit.messageHandlers.console "log")) {
            window.console.log.postMessage(msg);
        }
    }
    ...
    function alertOrLog(msg, shouldAlert) {
        if (shouldAlert) {
            ...
            webkit.messageHandlers.consoleog.postMessage(msg);
        }
    }
